...
| 20-slim | 1.6.0-alpha.5 | `docker pull ghcr.io/productioncity/saltcorn:1.6.0-alpha.5-20-slim` | ✅ |
...
| 22-slim | 1.6.0-alpha.5 | `docker pull ghcr.io/productioncity/saltcorn:1.6.0-alpha.5-22-slim` | ✅ |
...
| 23-slim | 1.6.0-alpha.5 | `docker pull ghcr.io/productioncity/saltcorn:1.6.0-alpha.5-23-slim` | ✅ |
...
| 24-slim | 1.6.0-alpha.5 | `docker pull ghcr.io/productioncity/saltcorn:1.6.0-alpha.5-24-slim` | ✅ |
## 📑 Tag Cheat-Sheet
